...
# wp core install --url=https://localhost --title="inception" --admin_user=ahmad --admin_password=onepieceisgoat123 --admin_email=mohammedannahri18@gmail.com --allow-root
